# -*- coding: utf-8 -*-
"""
Created on Sat Dec 12 15:22:20 2020
...
def mine():
    ...
    if blockchain.transaction_en_cours == []:
    ...
    nouveau_bloc = Block(index=dernier_bloc.index + 1, transactions=blockchain.transaction_en_cours, timestamp=time.time(), hash_precedent=dernier_bloc.hash)
